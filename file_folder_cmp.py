...
def cli(path1, path2, choice, verbose):
    ...
    '''This Command helps Scan 2 folder tos search for similar/different files or folders in Them.
        The syntax of this command is fld_cmp [PATH1] [PATH2] 1/2/3 where PATH1 represents the address
        ...
        2 for different files/folders or 3 to sync the two folders.'''
